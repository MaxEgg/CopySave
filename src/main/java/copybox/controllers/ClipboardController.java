...
import copybox.clipboard.ClipboardContent;
import copybox.clipboard.ClipboardEvent;
import copybox.clipboard.ClipboardItem;
import copybox.clipboard.ClipboardItem.DataType;
import copybox.clipboard.ClipboardListener;
import copybox.clipboard.HtmlTransferable;
import copybox.clipboard.ImageTransferable;
import copybox.sizedTreeMap.OverFlowEvent;
import copybox.sizedTreeMap.SizedTreeMap;
import copybox.front.components.ClipboardItemView;
...
import copybox.sizedTreeMap.SizedTreeMapListener;
...
import copybox.singleton.Stages;
...
public class ClipboardController implements SizedTreeMapListener {
    ...
    private void initView() {
        ...
        scrollPane.setStyle("-fx-background: #FF9900; -fx-border-color: transparent;");
        ...
        vbox.setSpacing(settings.itemSpacing);
            ...
            Platform.runLater(new Runnable() {
                ...
                public void run() {
                    if (e.getClipboardItem().getDataType() == DataType.IMAGELIST) {
                        ...
                        System.out.println("add item content: " + e.getClipboardItem().getText());
